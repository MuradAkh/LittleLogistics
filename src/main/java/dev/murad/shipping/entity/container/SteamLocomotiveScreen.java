...
public class SteamLocomotiveScreen extends AbstractLocomotiveScreen<SteamLocomotiveEntity, SteamHeadVehicleContainer<SteamLocomotiveEntity>> {
    ...
    public SteamLocomotiveScreen(SteamHeadVehicleContainer menu, Inventory inventory, Component p_i51105_3_) {
