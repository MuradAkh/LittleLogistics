...
public class FluidTankInsertBargeModel<T extends Entity & Colorable> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ShippingMod.MOD_ID, "fluid_tank_insert_barge_model"), "main");
