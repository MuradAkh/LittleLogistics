...
public class TrimBargeModel extends EntityModel<AbstractBargeEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create()
				...
				.texOffs(0, 0).addBox(6.0F, -29.0F, -7.0F, 2.0F, 2.0F, 14.0F)
				// Short Side
				.texOffs(19, 2).addBox(-6.0F, -29.0F, -9.0F, 12.0F, 2.0F, 2.0F)
				.texOffs(19, 2).addBox(-6.0F, -29.0F, 7.0F, 12.0F, 2.0F, 2.0F), PartPose.offset(0.0F, 23.0F, 0.0F));
