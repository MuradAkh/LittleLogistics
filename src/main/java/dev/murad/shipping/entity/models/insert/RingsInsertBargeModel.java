...
public class RingsInsertBargeModel<T extends Entity & Colorable> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ShippingMod.MOD_ID, "rings_insert_barge_model"), "main");
